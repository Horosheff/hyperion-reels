...
def build_metadata(index: int, clip: dict, text: str, profile: str) -> dict:
    ...
    return {
        ...
        "cover_prompt": (
            f"Вертикальная обложка 9:16 для Shorts/Reels/TikTok. Светлый белый / off-white фон, "
            f"крупный эмоциональный герой, контрастный современный дизайн (синий/чёрный/белый), "
            f"короткий русский хук крупным шрифтом: «{cover_hook}». "
            "Читаемо на телефоне, без тёмного фона, без мелкого текста, без водяных знаков."
        ),
